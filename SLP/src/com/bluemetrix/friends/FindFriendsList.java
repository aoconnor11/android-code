...
public class FindFriendsList extends SherlockActivity 
{
	...
	private ArrayList<Friend> myF = new ArrayList<Friend>();
    ...
    public void onCreate(Bundle savedInstanceState) 
	{
		...
		list.setOnItemClickListener(new OnItemClickListener() 
		{
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) 
			{
				...
				//go to message page
				Intent intent = new Intent(FindFriendsList.this, FriendsMenu.class);
	    	    startActivity(intent);
			}
		});

		//Inflate the custom view
		View customNav = LayoutInflater.from(this).inflate(R.layout.titlebar_friends_found, null);
		...
		cancel.setOnClickListener(new OnClickListener() 
		{
			...
			{	
				Intent in = new Intent(FindFriendsList.this, FriendsMenu.class);
				startActivity(in);    			
			}
		});
