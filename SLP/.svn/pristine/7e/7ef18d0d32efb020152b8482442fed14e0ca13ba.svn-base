...
public class MainView extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		points = i.getIntExtra("originalPoints", 100);
		totalPoints = i.getIntExtra("totalpoints", 0);		
		...
		System.out.println("torso " + torsoOption);
		...
		help.setOnClickListener(new View.OnClickListener() 
		{
	        ...
	        public void onClick(View arg0) 
	        {
	        	if(option==1)
	        	{
	        		...
	        		Intent in = new Intent(MainView.this, LearnMoreHelp.class);
		...
		if(option==1)
		{
			doneButton.setOnClickListener(new View.OnClickListener() 
			{
			    ...
			    public void onClick(View arg0) 
				{
			        ...
			        Intent in = new Intent(MainView.this, FragmentChangeActivity.class);
